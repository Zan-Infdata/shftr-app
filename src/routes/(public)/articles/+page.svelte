<script lang="ts">
    ...
    onMount(() =>{
        ...
        const url = `${Enviroment.ROOT_URL}/articles?/loadData`;
...
<header class="bg-dark py-5">
    <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
            ...
            <p class="lead fw-normal text-white-50 mb-0">Browse our Articles</p>
        </div>
    </div>
</header>
                ...
                <div class="col mb-5">
                    <div class="card h-100">
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="{Enviroment.ROOT_URL}/articles/{c01}">View</a></div>
                        </div>
                    </div>
                </div>
                {/if}
